...
include '../basedados/basedados.h';
    ...
    if (isset($_GET['id']) && isset($_GET['id_curso'])) {
        ...
        if($result){
            ...
            $sql = "UPDATE curso SET vagas_prenchidas = vagas_prenchidas + 1 WHERE id_curso = '$idCurso'";
            $result = mysqli_query($conn, $sql);
            ...
            <strong>Alerta!</strong> <a href="gerirInscricoes.php" class="alert-link">Sucesso!!!</a></div>';
                ...
                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                <strong></strong> <a href="gerirInscricoes.php" class="alert-link">Erro ao dar Aceitar!!!</div>';
            }
        }else{
            echo '<link rel="stylesheet" href="bootstrap.css">
                <div class="alert alert-dismissible alert-danger">
